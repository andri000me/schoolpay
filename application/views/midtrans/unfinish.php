...
<body class="horizontal-layout horizontal-menu 1-column  blank-page blank-page">
    <div class="app-content content bg-black">
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-lg-4 col-md-6 col-10 p-0">
                            <div class="card-header bg-transparent border-0">
                                <h2 class="error-code text-center mb-2 grey">UNFINISH</h2>
                                <h3 class="text-uppercase text-center grey">Transaction is unfinish.</h3>
                                <br>
                                <!-- <button class="btn btn-block border grey" onclick="window.history.back();">Back</button> -->
                            </div>
                        </div>
                    </div>
                </section>
